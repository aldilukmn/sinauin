...
export function Header() {
  ...
  return (
    <>
      <header className={`sticky top-0 z-50 w-full border-b print:hidden transition-colors ${isMobileMenuOpen ? 'bg-white' : 'bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60'}`}>
