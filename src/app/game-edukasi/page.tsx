...
export default function GameEdukasi() {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <p className="text-slate-500 mb-8 leading-relaxed">
          Fitur Game Edukasi sedang dalam tahap pengembangan. Kami sedang menyiapkan pengalaman belajar yang interaktif dan menyenangkan untuk Anda. Nanti balik lagi ya!
        </p>
