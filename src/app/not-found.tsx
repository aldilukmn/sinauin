  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-slate-900 mb-3">Oops! Tersesat?</h1>
        <p className="text-slate-500 mb-8 leading-relaxed">
          Halaman yang Anda cari sepertinya tidak ada atau telah dipindahkan. Jangan khawatir, mari kita kembali ke jalan yang benar.
        </p>
